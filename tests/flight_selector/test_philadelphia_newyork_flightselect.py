...
class TestPhiladelphiaNewYork(unittest.TestCase):
    ...
    def test_form_submission(self):
        ...
        self.assertIn("Flights from Philadelphia to New York", header.text, "Test Failed: Header did not contain the expected text.")

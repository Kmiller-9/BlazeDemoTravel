...
class TestPhildadelphiaCairo(unittest.TestCase):
    ...
    def test_form_submission(self):
        ...
        destination_city.send_keys("Cairo")
        ...
        self.assertIn("Flights from Philadelphia to Cairo", header.text, "Test Failed: Header did not contain the expected text.")

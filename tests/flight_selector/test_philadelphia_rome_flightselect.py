...
class TestPhiladelphiaRome(unittest.TestCase):
    ...
    def test_form_submission(self):
        ...
        destination_city.send_keys("Rome")
        ...
        self.assertIn("Flights from Philadelphia to Rome", header.text, "Test Failed: Header did not contain the expected text.")

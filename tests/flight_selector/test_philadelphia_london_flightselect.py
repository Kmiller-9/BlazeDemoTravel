...
class TestPhiladelphiaLondon(unittest.TestCase):
    ...
    def test_form_submission(self):
        ...
        destination_city.send_keys("London")
        ...
        self.assertIn("Flights from Philadelphia to London", header.text, "Test Failed: Header did not contain the expected text.")

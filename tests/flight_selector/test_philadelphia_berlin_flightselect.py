...
class TestPhiladelphiaBerlin(unittest.TestCase):
    ...
    def test_form_submission(self):
        ...
        self.assertIn("Flights from Philadelphia to Berlin", header.text, "Test Failed: Header did not contain the expected text.")

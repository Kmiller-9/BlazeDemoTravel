...
class MexicoCityBerlin(unittest.TestCase):
    ...
    def test_form_submission(self):
        ...
        departure_city.send_keys("Mexico City")
        ...
        self.assertIn("Flights from Mexico City to Berlin", header.text, "Test Failed: Header did not contain the expected text.")

...
class MexicoCityDublin(unittest.TestCase):
    ...
    def test_form_submission(self):
        ...
        self.assertIn("Flights from Mexico City to Dublin", header.text, "Test Failed: Header did not contain the expected text.")
